...
<body>
	...
	<div id="page-container" class="page-container fade page-sidebar-fixed page-header-fixed">
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Servicios <small>lista de tipos de empresa</small></h1>
			<!-- end page-header -->
			<!-- begin panel -->
			<div class="panel panel-inverse">
                ...
                <table id="lista_empresa" class="table table-striped table-bordered table-td-valign-middle">
					<thead>
						<tr>
                        <th width="1%">Item</th>
							<th width="59%">Nombre</th>
	...
	<script src="../MntEmpresa/empresa.js"></script>

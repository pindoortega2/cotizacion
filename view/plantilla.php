...
<body class="pace-top">
	...
	<div id="page-container" class="fade">
		...
		<ul class="login-bg-list clearfix">
			...
			<li><a href="javascript:;" data-click="change-bg" data-img="assets/img/login-bg/login-bg-16.jpg" style="background-image: url(../assets/img/login-bg/login-bg-16.jpeg)"></a></li>
			<li><a href="javascript:;" data-click="change-bg" data-img="assets/img/login-bg/login-bg-15.jpg" style="background-image: url(../assets/img/login-bg/login-bg-15.jpeg)"></a></li>
			<li><a href="javascript:;" data-click="change-bg" data-img="assets/img/login-bg/login-bg-14.jpg" style="background-image: url(../assets/img/login-bg/login-bg-14.jpeg)"></a></li>
			<li><a href="javascript:;" data-click="change-bg" data-img="assets/img/login-bg/login-bg-13.jpg" style="background-image: url(../assets/img/login-bg/login-bg-13.jpeg)"></a></li>
			<li><a href="javascript:;" data-click="change-bg" data-img="assets/img/login-bg/login-bg-12.jpg" style="background-image: url(../assets/img/login-bg/login-bg-12.jpeg)"></a></li>
		</ul>
		<!-- end login-bg -->
			...
			<div class="theme-panel-content">
				...
				<div class="theme-version">
					<a href="index_v2.html" class="active">
						<span style="background-image: url(../assets/img/theme/default.jpeg);"></span>
					</a>
					<a href="..\transparent\index_v2.html">
						<span style="background-image: url(../assets/img/theme/transparent.jpeg);"></span>
					</a>
				</div>
				<div class="theme-version">
					<a href="..\apple\index_v2.html">
						<span style="background-image: url(../assets/img/theme/apple.jpeg);"></span>
					</a>
					<a href="..\material\index_v2.html">
						<span style="background-image: url(../assets/img/theme/material.jpeg);"></span>
					</a>
				</div>
				<div class="theme-version">
					<a href="..\facebook\index_v2.html">
						<span style="background-image: url(../assets/img/theme/facebook.jpeg);"></span>
					</a>
				</div>
				<div class="divider"></div>
				...
				<div class="theme-version">
					<a href="index_v2.html" class="active">
						<span style="background-image: url(../assets/img/version/html.jpeg);"></span>
					</a>
					<a href="..\ajax\index.html">
						<span style="background-image: url(../assets/img/version/ajax.jpeg);"></span>
					</a>
				</div>
				<div class="theme-version">
					<a href="..\angularjs\index.html">
						<span style="background-image: url(../assets/img/version/angular1x.jpeg);"></span>
					</a>
					<a href="..\angularjs8\index.html">
						<span style="background-image: url(../assets/img/version/angular8x.jpeg);"></span>
					</a>
				</div>
				<div class="theme-version">
					<a href="..\laravel\index.html">
						<span style="background-image: url(../assets/img/version/laravel.jpeg);"></span>
					</a>
					<a href="..\vuejs\index.html">
						<span style="background-image: url(../assets/img/version/vuejs.jpeg);"></span>
					</a>
				</div>
				<div class="theme-version">
					<a href="..\reactjs\index.html">
						<span style="background-image: url(../assets/img/version/reactjs.jpeg);"></span>
					</a>
				</div>
				<div class="divider"></div>
				...
				<div class="theme-version">
					<a href="..\..\frontend\one-page-parallax\index.html">
						<span style="background-image: url(../assets/img/theme/one-page-parallax.jpeg);"></span>
					</a>
					<a href="..\..\frontend\e-commerce\index.html">
						<span style="background-image: url(../assets/img/theme/e-commerce.jpeg);"></span>
					</a>
				</div>
				<div class="theme-version">
					<a href="..\..\frontend\blog\index.html">
						<span style="background-image: url(../assets/img/theme/blog.jpeg);"></span>
					</a>
					<a href="..\..\frontend\forum\index.html">
						<span style="background-image: url(../assets/img/theme/forum.jpeg);"></span>
					</a>
				</div>
				<div class="divider"></div>
				<div class="row m-t-10">
					<div class="col-md-12">
						<a href="..\..\documentation\index.html" class="btn btn-inverse btn-block btn-rounded" target="_blank"><b>Documentation</b></a>
